# Batch 4 of 4 — PARALLEL (send after Batch 1 confirms complete)
...
Then proceed to Step 4 and create ONLY these files:
...
Do NOT create 01-blueprint.md or 02-styling-spec.md.
Do NOT run Step 5.
Do NOT update state.json.

After writing both files, stop and output:
"Batch 4 of 4 complete. Files created: lot-checklist-app/03-implementation-plan.md, lot-checklist-app/04-build-sequence-generator.md. When all batches confirm complete, send batch-FINAL-SOLO.md."
